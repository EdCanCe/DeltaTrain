...
<head>
    ...
    <title>DeltaTrain | Notificaciones</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="normal-content">
            ...
            <h1 class="follow-header">Notificaciones</h1>
            ...
            <?php
                ...
                $query = "SELECT * FROM Notis WHERE FKID_User_Notis = $CurrentUserID ORDER BY Date_Notis DESC";
                $result = mysqli_query($conexion, $query);
                while($row=mysqli_fetch_assoc($result)){
                    ?>
                        <a class="follow-list"  href="<?php echo $row["Source_Notis"] ?>">
                            <p><?php echo $row["Description_Notis"] ?></p>
                            <?php $rdate=date("j/F/y  g:i A", strtotime($row["Date_Notis"]));?>
