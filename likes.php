...
<body>
    ...
    <div class="main-content">
        ...
        <div class="normal-content">
            ...
            <h1 class="follow-header">Likes</h1>



            <?php
                if(!isset($_GET["postID"])){ #checa primero que se haya dado un usario
                ...
                $query = "SELECT User.* FROM User RIGHT JOIN LikedPost ON LikedPost.FKID_User_LikedPost = User.ID_User WHERE LikedPost.FKID_Post_LikedPost = ".$_GET["postID"];
                $result = mysqli_query($conexion, $query);
                while($row=mysqli_fetch_assoc($result)){
                    ?>
