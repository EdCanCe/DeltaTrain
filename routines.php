    ...
    <div class="main-content">
        ...
        <div class="recipes-main-container">
            ...
            <div class="recipes-body">
                ...
                <?php
                $query="SELECT Name_Routine, ID_Routine FROM Routine WHERE FKID_User_Routine =".$mainUser;
                $result = mysqli_query($conexion, $query);
                while($row=mysqli_fetch_assoc($result)){
                    ?>
                    <div class="recipes-container">
                        <a href="/DeltaTrain/routines/<?php echo $row["ID_Routine"]?>">
                        <h3 class="recipes-name"><?php echo $row["Name_Routine"] ?></h3>
                        </a>
                    </div>
                    <?php
                }
